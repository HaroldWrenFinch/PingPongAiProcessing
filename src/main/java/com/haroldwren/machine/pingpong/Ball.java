...
public class Ball {
    ...
    private static final Float RED = 255f, GREEN = 127f, BLUE = 237f, ALPHA = 255f;
     ...
     */
    public void show() {
        pAppletProxy.fill(RED, GREEN, BLUE, ALPHA);
        pAppletProxy.ellipse(xPoint, yPoint, radius *2, radius *2);
        xPreviousPoint = xPoint;
        yPreviousPoint = yPoint;
    }
